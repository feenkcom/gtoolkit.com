    ...
    <div class="row flex-column flex-md-row">
      <div class="col-12 col-md-4 col-lg-3 mb-4">
        <div class="list-group use-case-selector" id="use-case-list" role="tablist">
          ...
          <a class="list-group-item list-group-item-action d-flex flex-column align-items-start" id="use-case-llm-tab" data-bs-toggle="list" href="#use-case-llm" role="tab" aria-controls="use-case-llm">
            <h5>Dedicated AI chats</h5>
            <p class="mb-0 small">Design and explore domain-specific AI interactions</p>
          </a>
